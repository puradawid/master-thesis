...
\streszczeniepracy{
    ...
    zastanego kodu źródłowego, w konsekwencji optymalizując koszta
    ...
    potwierdzone.
    Niewielka ilość prac sugeruje istnienie takiego efektu, powołując się
    ...
    źródłowym.
    Programiści zostali podzieleni na dwie grupy, w których programy różniły
    się stopniem sprzężenia w obszarze poddawanemu zmianom.

    Wyniki sugerują różnice w średnim znormalizowanym czasie wykonania
    pomiędzy programami, jednakże wyniki te nie są statystycznie istotne:
    \(p = 0.25\), co sugeruje potrzebę większej grupy badawczej i zastosowanie
    mniej kosztownych technik przeprowadzenia eksperymentu, taką jak
    automatyzowane środowisko progrmaistyczne używane do przeprowadzania
    zadań rekrutacyjnych w firmach technologicznych.
