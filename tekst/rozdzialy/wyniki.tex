...
\begin{figure}[h]
    \centering \includegraphics[width=0.7\linewidth]{diagramy/normalized_time_comparison_first}
...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{\label{tab:wyniki_zadanie_pierwszestatystyka}Odchylenie standardowe, średnia, mediana, 25-ty i 75-ty percentyl dla zadania pierwszego w badanych grupach}
\end{table}
...
hipotezy zerowej \(H_{0}\) i przyjęcie hipotezy \(H_{1}\), która stwierdza,
że program o strukturze charakteryzującej się wyższym stopniem sprzężenia
wymaga statystycznie więcej czasu na wprowadzenie w nim zmian.
