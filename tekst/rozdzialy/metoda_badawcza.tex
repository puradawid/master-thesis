...
W pracy postawiono hipotezę badawczą, zgodnie z którą czas potrzebny na wprowadzenie zmian w kodzie programu zależy
od stopnia sprzężenia klas --- jeśli klasa jest powiązana z inną o znacząco różnym stopniu sprzężenia, to czas
ten różni się w sposób statystycznie istotny.
...
Jeżeli eksperyment dostarczy dwa czasy potrzebne na wykonanie zadania przez każdego z uczestników, czas zadania
wspólnego obu grupom może normalizować czas zadania o zmodyfikowanym stopniu sprzężenia klas.
...
\begin{itemize}
    ...
    \item podstawowa znajomość JUnit
\end{itemize}
